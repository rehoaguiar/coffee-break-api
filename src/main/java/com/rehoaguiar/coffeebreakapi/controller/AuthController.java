...
@Tag(name = "Autenticacao", description = "Endpoints para cadastro e login de usuarios.")
public class AuthController {

    private final AuthService authService;

    @Operation(summary = "Cadastrar usuario", description = "Cria um usuario e retorna um token JWT.")
    ...
    @Operation(summary = "Login", description = "Autentica um usuario cadastrado e retorna um token JWT.")
    @PostMapping("/login")
